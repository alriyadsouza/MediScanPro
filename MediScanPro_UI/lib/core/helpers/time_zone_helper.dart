...
class TimeZoneHelper {
  ...
  static tz.TZDateTime scheduleWeekly(DateTime time, {required List<int> weekday}) {
  ...
  static List<tz.TZDateTime> scheduleMultipleWeekly(
    ...
    for (final time in times) {
      ...
      final DateTime scheduledTime = DateTime(formattedTime.hour, formattedTime.minute);
